...
public class wigBedToSgrTest {
    ...
    public void shouldThrowIllegalArgumentIfInputFileIsNull()
        ...
        Converter.wigToSgr("bed", null, "resources/conversionTestData/" +
    ...
    public void shouldThrowIllegalArgumentIfOutputFileIsNull()
            throws FileNotFoundException{
        Converter.wigToSgr("bed", "resources/conversionTestData/WIG-from-SGR-testdata.wig",
                null);
    }
    ...
    public void shouldNotAcceptWrongFileTypeForInput()
            throws FileNotFoundException {
        Converter.wigToSgr("bed", "resources/conversionTestData/BED-testdata.bed",
    ...
    public void wigbedToSgrCheckSumTest() throws InterruptedException,
        ...
        try{
            ...
            expectedFile = new File("resources/conversionTestData/expectedResults/wigbedToSgr.sgr");
