...
public class Main {
	...
	// "test/male.bam", "test/maleSoIOExceptionrted"};
	// String bamToWig =
	...
	public static void main(String[] args) throws ProcessException {
		...
		String inFile = "/home/c11/c11oan/edu/5dv151/genomizer-server/resources/test/";
		String outFile = "/home/c11/c11oan/edu/5dv151/genomizer-server/resources/test2/";
		...
		try {
			...
			System.out.println("allting g�r h�r = " + p.executeProcess("rawToProfile", para, inFile, outFile));
