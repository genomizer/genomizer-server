...
public class UploadHandler {
    public void handleGET(HttpExchange exchange) {
        try {
            ...
            Debug.log("Error in UploadHandler.handleGET: " + e.getMessage());
    ...
    public void handlePOST(final HttpExchange exchange) {
        try {
            ...
            // TODO: don't hardcode the temp directory location.
            ...
            for (FileItem fileItem : fileItems) {
                if (!fileItem.isFormField()) {
                    ...
                    File outFile = new File("resources/" + fileItem.getName());
            ...
            Debug.log("Error in UploadHandler.handlePOST: " + e.getMessage());
            ErrorLogger.log("SYSTEM", e);
            e.printStackTrace();
        }
    }
