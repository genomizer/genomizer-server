...
public class ConversionHandler {
	...
	private static String OUTPUTPATH = ServerSettings.fileLocation;
	 ...
	 * @throws IOException
	 */
	public void convertProfileData(String newFormat, int id) throws SQLException, IOException {
		db = initDB();
		...
		db.addNewFile(file.expId, Integer.parseInt(file.type), file.filename,
				file.inputFilePath, file.metaData, file.author,
				"Generated by server", file.isPrivate, file.grVersion);
