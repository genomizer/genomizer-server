...
public class ChainFiles {
    ...
    /**
     * Creates a chain files object from a ResultSet. Don't call
     * this constructor directly, use
     * {@link database.DatabaseAccessor#
     * getChainFiles(String fromVersion, String toVersion)
     * getChainFiles} to create a chain file object.
     * @param rs the ResultSet.
     * @throws SQLException
     */
    public ChainFiles(ResultSet rs) throws SQLException {
